...
namespace CensusAnalyzerTest
{
    public class UnitTest
    {
        ...
        static string wrongHeaderStateFilePath = @"D:\BridgeLabz\Indian_State_Census\CensusAnalyzerTest\CSVFiles\IndiaStateCensusDatas.txt";
        ...
        {
            var censusException = Assert.Throws<CensusAnalyserException>(
                () => censusAnalyser.LoadCensusData(CensusAnalyser.Country.INDIA, wrongHeaderindianCensusFilePath, indianStateCensusHeaders));

            var stateException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(CensusAnalyser.Country.INDIA, wrongHeaderStateFilePath, indianStateCodeHeaders));
